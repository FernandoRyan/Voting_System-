...
{
    public partial class Tamil_National_People_s_Front : Form
    {
        //Decalration of member public feilds 
        ...
        public Tamil_National_People_s_Front()
        {
            InitializeComponent();
            loadCandidates();
        }
        ...
        private void loadCandidates()
        {
            ...
            String qry = "SELECT CandidateNumber FROM candidate_tb WHERE party ='Tamil National Peoples Front'";
            try
            {
                conn.Open();
                        ...
                        using (cmd)
                        {
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    ...
                                    cmd2.Parameters.AddWithValue("@party", "Tamil National Peoples Front");
        ...
        private void Tamil_National_People_s_Front_Load(object sender, EventArgs e)
        {
